  ...
  <section class="about-section team-section">
    ...
    <div class="team-grid">
      ...
      <div class="team-card">
        ...
        <h3>簡嘉葳</h3>
        <h4>負責留言板功能（支援中文顯示、依日期排序及最新留言置頂）、會員登入控制、商品搜尋、訪客計數器、產品管理（新增、上架、修改、刪除商品）、管理者訂單瀏覽、會員優惠設計，以及網站整合測試工作；同時參與購物車結帳功能開發、CSS版面設計與背景圖製作，並與全體組員共同完成首頁組員介紹及心得撰寫。</h4>
      ...
      <div class="team-card">
        ...
        <h3>神林俊希</h3>
        <h4>主要負責資料庫設計，網站安全與法規相關功能，包括 ERD 與資料表設計、SQL Injection 防護、個資法與 Cookie 告知等法律規範實作，並協助統一全站 API 資料結構、優化管理者系統及進行整體整合測試。此外，也與全體組員共同完成首頁組員介紹及心得撰寫。</h4>
